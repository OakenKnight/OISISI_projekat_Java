...
public class HelpFrame extends JFrame{
	public HelpFrame (){
		...
		uputstvo.setText("1) FUNKCIONALNOSTI NAD TIPOM ENTITETA STUDENTI\n"
				...
				+ "Nakon pispravno unesenih podataka potrebno je kliknuti na dugme za pretragu. Pomocu dugmeta za reset moguce je vratiti se\n"
				+ "na prvobitan prikaz svih profesora\n\n"
				+ "3) FUNKCIONALNOSTI NAD TIPOM ENTITETA PREDMETI\n"
				+ "3.1) Prikaz predmeta: \n"
				...
				+ "profesor sa izabranog predmeta\n");
